...
While we are just getting started with our next version of MDL, you can see our current progress on [master](https://github.com/Sunwuyuan/material-design-lite/tree/master) as well as an overview of the direction we're headed in our [(WIP) developer guide](https://github.com/Sunwuyuan/material-design-lite/blob/master/docs/DEVELOPER.md) as well as our [initial POC branch](https://github.com/Sunwuyuan/material-design-lite/tree/experimental/v2-architecture-poc) for our new architecture.

If you're interested in information for a specific MDL v2 component, check out our [v2-component issues](https://github.com/Sunwuyuan/material-design-lite/issues?utf8=%E2%9C%93&q=is%3Aissue%20is%3Aopen%20label%3Av2-component) to see which v2 milestone it's associated with and feel free to subscribe to that issue for updates.
